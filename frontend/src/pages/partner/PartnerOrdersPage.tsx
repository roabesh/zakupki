...
import { ShoppingBag, Clock, ArrowLeft, Package } from 'lucide-react'
...
// Карточка заказа (только для просмотра, без действий)
...
// Страница заказов партнёра (только просмотр)
