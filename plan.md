...
### Этап 7: Django Admin (расширенная) [x]
- [x] Список заказов с фильтрами и цветовой индикацией статуса
- [x] Actions: смена статуса + async email клиенту
- [x] Inline OrderItem с суммой позиции в заказе
